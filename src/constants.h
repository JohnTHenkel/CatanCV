...
const double BOARD_AREA_MIN_THRESHOLD=400000;
const double BOARD_AREA_MAX_THRESHOLD=700000;
const double HEX_AREA_MAX_THRESHOLD=10000;
const double HEX_AREA_MIN_THRESHOLD=500;